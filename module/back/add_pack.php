...
if(isset($_POST['mota']))
	{   
		...
		$mota=$_POST['mota'];
		$active=$_POST['active'];
		$sql = "Insert into `lk_pack` values (null,'$name','$price','$mota','$active')";
...
<table class="col-md-12 col-sm-12 col-xs-12">
  ...
  <tr>
    ...
    <td width="297" align="left">&nbsp;
    	<input value="" type="text" name="price" class="col-md-12 col-sm-12 col-xs-12" required style="height:50px; margin-bottom:20px">
    </td>
  </tr>    
  <tr>
    <td width="130" height="36" align="center">Mô Tả <p style="color:red">*</p></td>
    <td width="600" align="left">&nbsp;
    	<textarea  name="mota" id="mota" class="ckeditor" required></textarea>
    </td>
  </tr>
