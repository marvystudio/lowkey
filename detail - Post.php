                ...
                <div class="detail-info detail-form">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <input id="namecus" name="namecus" class="form-control detail-input" type="text" placeholder="Nhập tên(*)" required>
                        </div>
                        <div class="col-md-6 mb-4">
                            <input id="mailcus" name="mailcus" class="form-control detail-input" type="text" placeholder="Nhập email(*)" required>
                        </div>
                        <div class="col-md-6 mb-4">
                            <input id="phonecus" name="phonecus" class="form-control detail-input" type="text" placeholder="Nhập số điện thoại(*)" required>
                        </div>
                        <div class="col-md-6 mb-4">
                            <input id="comcus" name="comcus" class="form-control detail-input" type="text" placeholder="Tên công ty">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tab-content">
            <div class="tab-pane container active p-0" id="business">
                <div class="row detail-text-divider mt-5">
                 ...
                 <button class="btn detail-btn detail-send" type="submit">
                            Tiếp
                        </button>
                        </form>
                <!--<div class="row detail-text-divider mt-5">
